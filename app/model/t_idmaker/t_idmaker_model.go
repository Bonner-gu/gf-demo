...
// arModel is a active record design model for table t_idmaker operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of t_idmaker.
	Table = "t_idmaker"
	// Model is the model object of t_idmaker.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table t_idmaker.
	Columns = struct {
		Id         string // 流水号
		Key        string // key
		Value      string // value
